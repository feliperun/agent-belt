...
pub fn build(b: *std.Build) void {
    ...
    inline for (.{ "src/config.zig", "src/key_edges.zig", "src/knob.zig", "src/f5.zig", "src/sessions/cli.zig", "src/sessions/local.zig", "src/sessions/intent.zig", "src/audio_level.zig", "src/history.zig" }) |path| {
